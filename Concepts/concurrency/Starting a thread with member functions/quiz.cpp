/* Change the code from in a way that 
a new member variable _name of type std::string is added to the Vehicle class. 
...
int main()
{
    ...
    std::thread t1 = std::thread(&Vehicle::setName, v, "Srijith");
